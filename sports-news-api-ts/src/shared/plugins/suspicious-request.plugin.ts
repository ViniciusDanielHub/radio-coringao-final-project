...
const TRACKING_WINDOW_MS = 5 * 60 * 1000; // 5 minutos
const BLOCK_THRESHOLD = 50; // requests com erro em 5 min = ban
const BLOCK_DURATION_MS = 15 * 60 * 1000; // ban por 15 min
const CLEANUP_INTERVAL_MS = 60 * 1000; // limpar a cada 1 min
