...
export default async function SportPage({ params }: Props) {
  ...
  const nextMatchData = nextMatch[0]
    ? {
        ...
        date: new Date(nextMatch[0].date).toLocaleDateString("pt-BR", { weekday: "short", day: "2-digit", month: "2-digit" }),
        time: new Date(nextMatch[0].date).toLocaleTimeString("pt-BR", { hour: "2-digit", minute: "2-digit" }),
